...
- Report id: `2f633db9-e7b9-5b16-a734-0f7f8c0d94ef`

## Rule-outcome matrix (25 rules × 13 cases)

| Rule | Category | Batch 07 admissibility | Outcome counts | Evidence | Metric | Readiness |
| --- | --- | --- | --- | --- | --- | --- |
| `BORROW_AVAILABILITY_CHANGE_MAXIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `BORROW_AVAILABILITY_MAXIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `BORROW_FEE_CHANGE_MINIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `BORROW_FEE_MINIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `COMPLETED_BAR_AVAILABLE` | MOMENTUM_DISCOVERY | ADMISSIBLE | PASS=13 | true | false | false |
| `CORPORATE_ACTION_CONTEXT_AVAILABLE` | CATALYST_EVIDENCE | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `DAYS_TO_COVER_MINIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `FLOAT_MAXIMUM` | MOMENTUM_DISCOVERY | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `MARKET_DATA_AVAILABLE` | MOMENTUM_DISCOVERY | ADMISSIBLE | PASS=13 | true | false | false |
| `NEWS_AVAILABLE` | CATALYST_EVIDENCE | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `NEWS_AVAILABLE_BEFORE_AS_OF` | CATALYST_EVIDENCE | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `NEWS_TIMESTAMP_KNOWN` | CATALYST_EVIDENCE | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `NO_DEFAULT_SUBSTITUTION` | EVIDENCE_VALIDITY | NOT_APPLICABLE | PASS=13 | false | false | false |
| `NO_MATERIAL_CONFLICTS` | EVIDENCE_VALIDITY | NOT_APPLICABLE | PASS=13 | false | false | true |
| `PERCENTAGE_CHANGE_MINIMUM` | MOMENTUM_DISCOVERY | ADMISSIBLE_WITH_CONSTRAINTS | PASS=13 | false | true | false |
| `POINT_IN_TIME_ELIGIBLE` | EVIDENCE_VALIDITY | NOT_APPLICABLE | PASS=13 | false | false | true |
| `PRICE_RANGE` | MOMENTUM_DISCOVERY | BLOCKED_MISSING_SEMANTICS | UNKNOWN=13 | false | false | false |
| `PROVIDER_SCOPE_EXPLICIT` | EVIDENCE_VALIDITY | NOT_APPLICABLE | UNKNOWN=13 | false | false | false |
| `PUBLISHED_SHORT_INTEREST_AVAILABLE` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `RELATIVE_VOLUME_MINIMUM` | MOMENTUM_DISCOVERY | BLOCKED_MISSING_SEMANTICS | UNKNOWN=13 | false | false | false |
| `REQUIRED_DOMAINS_PRESENT` | EVIDENCE_VALIDITY | NOT_APPLICABLE | FAIL=13 | false | false | true |
| `REQUIRED_HISTORY_SUFFICIENT` | EVIDENCE_VALIDITY | NOT_APPLICABLE | PASS=13 | false | false | true |
| `REQUIRED_UNITS_COMPATIBLE` | EVIDENCE_VALIDITY | NOT_APPLICABLE | PASS=13 | false | false | true |
| `SEC_FILING_AVAILABLE` | CATALYST_EVIDENCE | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |
| `SHORT_INTEREST_PERCENTAGE_CHANGE_MINIMUM` | SHORT_PRESSURE_CONFIRMATION | BLOCKED_MISSING_EVIDENCE | UNKNOWN=13 | false | false | false |

## Aggregate counts

### rule_outcome_over_case_rule_pairs (denominator 325)

- `FAIL`: 13
- `PASS`: 104
- `UNKNOWN`: 208

### rule_outcome_over_categories (denominator 325)

- `CATALYST_EVIDENCE:UNKNOWN`: 65
- `EVIDENCE_VALIDITY:FAIL`: 13
- `EVIDENCE_VALIDITY:PASS`: 65
- `EVIDENCE_VALIDITY:UNKNOWN`: 13
- `MOMENTUM_DISCOVERY:PASS`: 39
- `MOMENTUM_DISCOVERY:UNKNOWN`: 39
- `SHORT_PRESSURE_CONFIRMATION:UNKNOWN`: 91
...
### freeze_status_over_cases (denominator 13)

- `REQUEST_AND_RESULT_FROZEN`: 13

### leakage_audit_over_cases (denominator 13)

- `LEAKAGE_AUDIT_PASSED`: 13
...
### missingness_blocking_reason_over_rule_case_pairs (denominator 455)

- `ABSOLUTE_PRICE_LEVEL_BLOCKED_BY_BATCH07`: 13
- `EVIDENCE_META_RULE_NOT_BAR_DEPENDENT`: 91
- `NO_DETECTION_TIME_EVIDENCE_EXISTS`: 169
- `REQUIRED_DOMAIN_ABSENT_FROM_EVIDENCE`: 169
- `VOLUME_SEMANTICS_BLOCKED_BY_BATCH07`: 13
...
- Cases: 13
- Outcome counts: FAIL=13, PASS=65, UNKNOWN=247
