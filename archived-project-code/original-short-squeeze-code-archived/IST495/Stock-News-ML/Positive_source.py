...
FINVIZ_API_KEY = "750b45bf-5158-4678-b841-b695656321df"  # Replace with your Finviz Elite API key

# ✅ Positive sentiment indicators
POSITIVE_KEYWORDS = [
    "beats", "surges", "jumps", "rises", "soars", "gain", "profits", "upgraded",
    "record", "growth", "tops", "exceeds", "strong", "accelerates", "expands",
    "increased", "positive", "rebound", "outperforms", "buyback", "dividend",
    "partnership", "approval", "launch", "greenlight", "wins", "boost", "acquisition",
    "strategic", "new deal", "hike", "adds", "increase", "patent","merge", "merger"
]
...
def fetch_potential_positive_headlines(ticker):
...
def fetch_all_finviz_api_positive_news():
    url = "https://elite.finviz.com/news_export.ashx?v=3&auth=750b45bf-5158-4678-b841-b695656321df"  # Replace token
    headers = {
...
if __name__ == "__main__":
    ...
    if not ticker:
        headlines = fetch_all_finviz_api_positive_news()
    else:
